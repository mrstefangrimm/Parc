...
void setup() {
  ...
  mcp.begin();
  mcp.pinMode(Pin_A, INPUT); mcp.pullUp(Pin_A, HIGH);
  mcp.pinMode(Pin_B, INPUT); mcp.pullUp(Pin_B, HIGH);
  mcp.pinMode(Pin_C, INPUT); mcp.pullUp(Pin_C, HIGH);
  mcp.pinMode(Pin_D, INPUT); mcp.pullUp(Pin_D, HIGH);
